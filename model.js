 ...
 */
  ...
  */
   ...
   *@param question String con la pregunta
   *@param answer String con la respesta
   */
    ...
    *objeto nuevo nuevo con todas las preguntas existentes.
 ...
 */
  ...
  */
  exports.deleteByIndex = id => {
  	const quiz = quizzes[id];
  	if (typeof quiz === "undefined"){
  		throw new Error(`El valor del parámtero id no es válido`);
  	}
  	quizzes.splice(id, 1);
    save();
  };
